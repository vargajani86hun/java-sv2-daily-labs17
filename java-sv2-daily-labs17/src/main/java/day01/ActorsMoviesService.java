...
public class ActorsMoviesService {
    ...
    public ActorsMoviesService(ActorsRepository actorsRepository, MoviesRepository moviesRepository,
    ...
    public void insertMovieWithActors(String title, LocalDate releaseDate, List<String> actorNames) {
        ...
        for (String actual: actorNames) {
            ...
            if (found.isPresent()) {
                ...
                actorId = actorsRepository.saveActorAndGetGeneratedId(actual);
            }
